 ...
 * @author user1
 */
public class EvenementuserFXMLController implements Initializable {
...
lbnom.setText(tabvue.getSelectionModel().getSelectedItems().get(0).getNom());
lblieu.setText(tabvue.getSelectionModel().getSelectedItems().get(0).getLieux());
lbnbplaces.setText(Integer.toString(tabvue.getSelectionModel().getSelectedItems().get(0).getNbrplaces()));
lbprix.setText(Float.toString(tabvue.getSelectionModel().getSelectedItems().get(0).getPrix()));
Date d=tabvue.getSelectionModel().getSelectedItems().get(0).getDate();
id=tabvue.getSelectionModel().getSelectedItems().get(0).getId();
lbdate.setText(d.toString());
...
public void envtsms (){
  ...
  //String AUTH_TOKEN = "your_auth_token";
   ...
   public void startpie(Stage primaryStage)  {
